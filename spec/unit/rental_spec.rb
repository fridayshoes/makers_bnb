...
describe Rental do
  describe '.all' do
    it 'returns all spaces' do
      ...
      expect(spaces.first.description).to eq "nice, sunny room"
  ...
  describe'.create' do
    it 'creates a new space' do
      Rental.create(space_name: 'Fred Farm', description: 'nice, sunny room', price_per_night: 70.00)

      expect(Rental.all).to include 'nice, sunny room'
    end
  end
end  